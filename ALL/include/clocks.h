...
/*
 * EMSI0 (SD/MMC) base clock is 50MHz.  Set max SD card operating
 * frequency to 12.5MHz for better reliability on the carrier board.
 */
#define SDCLK         (50000000)
#define SDCLK_MAX     (12500000)
#define EMMCCLK_MAX   (25000000)
